...
Route::get('/admin', 'AdminUserController@index')->name('admin_home')->middleware('can:Admin','can:Librarian');
...
Route::get('/books/list', 'BookController@index')->name('book_list')->middleware('can:User');
